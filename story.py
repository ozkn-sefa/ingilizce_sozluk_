...
class HikayeWidget(QWidget):
    ...
    def hikaye_olustur(self):
        ...
        prompt = f"Verilen kelimeleri kullanarak, her kelimenin son harfinden başlayan bir sonraki kelimeyle zincir mantığında ilerleyen, akıcı, yaratıcı ve anlamlı bir Türkçe hikaye oluştur. Kelimeler, hikayenin akışında doğal bir şekilde kullanılmalı ve her kelime, bir önceki kelimenin son harfiyle başlayan bir sonraki kelimeyle bağlanmalı. Hikaye yalnızca metin formatında olacak, başlık, açıklama veya başka eklemeler içermeyecek. Kelimeler: {', '.join(user_words)}"
